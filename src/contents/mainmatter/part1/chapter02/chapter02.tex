...
\paragraph*{}
\blindtext
The \index{Warp Factor}Warp Factor vs. Speed in terms of Speed of Light graph is shown in \figref{fig:warp}. The relationship between Warp Factor and Speed is the following:
\begin{equation*}
    WF
    =
    \sqrt[3]{\frac{V}{c}}
